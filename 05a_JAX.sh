#!/bin/bash
#SBATCH --job-name=JAX
#SBATCH --output=/lustre/home/harrell_lab/bulkRNASeq/Ancestry_dev/resources/WGS/JAX_job_%j.out
#SBATCH --mem=120G
#SBATCH -c 10
...
# HaplotypeCaller_data_dir="/lustre/home/harrell_lab/bulkRNASeq/Ancestry_dev/Ancestry_Results_GATK/Data/BaseRecalibrator"
# JAX_data_dir="/lustre/home/harrell_lab/bulkRNASeq/Ancestry_dev/Ancestry_Results/Data/JAX_RNA_GATK_resources_test"
# JAX_csv="/lustre/home/harrell_lab/bulkRNASeq/Ancestry_dev/JAX_samplesheet_RNA_GATK.csv"

HaplotypeCaller_data_dir="/lustre/home/harrell_lab/bulkRNASeq/Ancestry_dev/WGS"
JAX_data_dir="/lustre/home/harrell_lab/bulkRNASeq/Ancestry_dev/Ancestry_Results/Data/JAX_WGS_resources_test"
JAX_csv="/lustre/home/harrell_lab/bulkRNASeq/Ancestry_dev/JAX_samplesheet_WGS.csv"
